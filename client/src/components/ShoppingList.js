...
import { FaStar, FaCheck,FaPlus, FaTrash, FaArrowUp, FaArrowDown, FaUndo } from 'react-icons/fa';

export const ShoppingListTable = ({ items, toggleImportant, toggleBought, deleteItem, addOrIncrementItem, isBoughtList, moveItem }) => {
